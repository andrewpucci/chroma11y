...
{:else if name === 'json'}
  <svg width={size} height={size} viewBox="0 0 256 256" fill="none" aria-hidden="true">
    <defs>
      <linearGradient id="json-gradient-1" x1="15.791%" x2="91.009%" y1="14.737%" y2="85.228%">
        <stop offset="0%" stop-color="currentColor" />
        <stop offset="100%" stop-color="currentColor" stop-opacity="0.3" />
      </linearGradient>
      <linearGradient id="json-gradient-2" x1="82.136%" x2="-3.113%" y1="85.237%" y2="14.79%">
        <stop offset="0%" stop-color="currentColor" />
        <stop offset="100%" stop-color="currentColor" stop-opacity="0.3" />
      </linearGradient>
    </defs>
...
{:else if name === 'css'}
  <svg width={size} height={size} viewBox="0 0 256 232" fill="none" aria-hidden="true">
    <path
      fill="currentColor"
      d="m100.902 231.618l116.456-38.653L256 0H37.867L29.57 43.056h174.812l-5.443 27.49H23.862L15.3 113.602h174.823l-9.602 49.284l-70.547 23.076l-60.955-23.076l4.16-21.528H10.123L0 192.965z"
    />
  </svg>
{:else if name === 'share'}
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
...
{:else}
  <!-- Fallback for invalid icon names - alert/warning icon -->
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true">
